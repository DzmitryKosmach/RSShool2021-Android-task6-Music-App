...
class MediaPlaybackService : MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        mediaSession = MediaSessionCompat(baseContext, LOG_TAG).apply {
            ...
            player = SimpleExoPlayer.Builder(this@MediaPlaybackService).build().apply {
                ...
                if (!audioFocusRequested) {
                    ...
                    val audioFocusResult = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        ...
                        audioManager!!.requestAudioFocus(
                            //this@MediaPlaybackService.audioFocusChangeListener,
                            {},
...
//                        this@MediaPlaybackService.audioFocusChangeListener
    ...
    private val audioFocusChangeListener =
        OnAudioFocusChangeListener { focusChange ->
            when (focusChange) {
                AudioManager.AUDIOFOCUS_GAIN -> this@MediaPlaybackService.sessionCallback.onPlay() // Не очень красиво
